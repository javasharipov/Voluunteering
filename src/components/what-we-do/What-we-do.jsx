	...
	return (
		<section className='mt-[96px] mb-[96px]'>
			<div className='container mx-auto max-w-[1280px]'>
				...
				<div className='flex gap-[110px] items-center mb-[96px]'>
					<div className='w-full text-[#1D2130]'>
						<h2 className='text-[56px] font-bold leading-[67.2px mb-[34px]'>
							We are working worldwide
						</h2>
						<p className='text-[#525560] text-[16px] font-medium'>
			...
			<div className='bg-[#EFF7F2]'>
				<div className='container mx-auto max-w-[1280px]'>
					<h2 className='text-[#1D2130] text-[48px] font-bold pt-[96px] pb-[64px]'>
					...
					<div className='grid grid-cols-3 gap-[64px] pb-[96px]'>
						<div>
							<div className='flex items-start gap-[24px]'>
								...
								<h2 className='text-[#1D2130] text-[24px] font-bold leading-[28px]'>
									Build healthy cities{' '}
									<p className='text-[#525560] text-[14px] font-medium leading-[22px]'>
										Lorem ipsum dolor sit amet, consectetur adipiscing elit.
			...
			<div className='container mx-auto max-w-[1280px] my-24'>
				<div className='flex flex-col items-center justify-center'>
					<span className='text-base font-bold text-[#1D2130]'>
